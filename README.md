...
-   ### User stories
    ...
    -   #### A. First Time Visitor Goals
        ...
        3. As a First Time Visitor, I want to be able to easily navigate to and view a weekly puzzle section.
        4. As a First Time Visitor, I want to be able to easily find where the organisation is located.

    -   #### B. Returning Visitor Goals

        1. As a Returning Visitor, I want to be able to access and view a updated weekly puzzle section.
    ...
    -   #### C. Frequent User Goals
        1. As a Frequent User, I want to be able to access and view a updated weekly puzzle section.
